...
void VG_Help_Story_Kennedy(int scene, int index)
{
	int rnd = 0;
	char punch;
	char punch2;
...
void VG_Init_Story_Kennedy(int index, int condition, int scene)
{
		...
		if(condition == VG_STORY_SCENE_LAST) 
		{
			...
			{   
				...
				if(VG_IS_AN_ALTER_P1 == false)
					sprintf( new_counter[1].word, "KEN HAS FOUND HIS MICROPHONE!"); 
				else
					sprintf( new_counter[1].word, "KEN HAS FOUND HIS MICROPHONE!"); 
			}
			if(index == 1) 
			{  
				...
				if(VG_IS_AN_ALTER_P1 == false)
					sprintf( new_counter[1].word, "NOW NO-ONE CAN SHUT HIM UP!"); 
				else
					sprintf( new_counter[1].word, "NOW NO-ONE CAN SHUT HIM UP!"); 
			}
			if(index == 2)   
