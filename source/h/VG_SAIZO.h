...
void Run_Moves_SAIZO(int player, int f_rate) 
{
	...
	if(sprite[index].status == VG_SPECIAL2_FONT)       
	{
		...
		{ 
			...
			{ 
				...
				if(sprite[index].movement == LEFT)
					New_FX(points[point_index].x-0.05f, points[point_index].y-0.05f,  points[point_index].x-0.05f, points[point_index].y-0.05f, bullet_anim, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 1, GFX, 1.0f, 0, index, FX_VG_KUNAI, index, 12, 0, 0, LEFT); 
				else
					New_FX(points[point_index].x-0.05f, points[point_index].y-0.05f,  points[point_index].x-0.05f, points[point_index].y-0.05f, bullet_anim, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 1, GFX, 1.0f, 0, index, FX_VG_KUNAI, index, 12, 0, 0, RIGHT); 
	...
	if(sprite[index].status == VG_SPECIAL1_FONT)       
	{
		...
		{   
			...
			{
				New_FX(points[point_index].x-0.05f, points[point_index].y-0.05f,  points[point_index].x-0.05f, points[point_index].y-0.05f, bullet_anim, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 2, GFX, 1.0f, 0, index, FX_VG_BOMBSAIZO, -1, 12, 0, 0, player); 
				VG_1_Grenadesfx = 1;	  
				VG_SlowMO(500, 2.0f);
			} 
			if(player == 2)  
