...
void Run_Moves_SIU(int player, int f_rate) 
{
	...
	if(sprite[index].status == VG_SPECIAL2_FONT)       
	{
		...
		/*	if(sprite[index].special == 3) // Mid pistol...
			if(player == 1)
				VG_1_OFFSET = 0.05f; 
			else
				VG_2_OFFSET = 0.05f;
		...
		//		points[point_index].active = 1;    
			...
			if(VG_1_Pistolsfx == 0)   
			{ 
				if(sprite[index].special != 4) // Mid pistol..
				{
					if(sprite[index].movement == LEFT)
				...
				{
					if(sprite[index].movement == LEFT)
						New_FX(points[point_index].x+0.03f, points[point_index].y-0.05f,  points[point_index].x+0.03f, points[point_index].y-0.05f, 8, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 1, GFX, 1.0f, sprite[index].movement, VG_shadow_index, FX_VG_CASING, VG_shadow_index, 12, 0, 0, (5+rand()%3)); 
					else
						New_FX(points[point_index].x-0.13f, points[point_index].y-0.05f,  points[point_index].x-0.13f, points[point_index].y-0.05f, 8, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 1, GFX, 1.0f, sprite[index].movement, VG_shadow_index, FX_VG_CASING, VG_shadow_index, 12, 0, 0, (5+rand()%3)); 

					New_FX(points[point_index].x-0.05f, points[point_index].y-0.095f,  points[point_index].x-0.05f, points[point_index].y-0.095f, bullet_anim, LOOP, 0.1f, 0.1f, 0.1f, 0.1f, 1, GFX, 1.0f, 0, index, FX_VG_BULLET_LOW, index, 12, 0, 0, -1); 
				}
				VG_1_Pistolsfx = 1;	  
			//	VG_SlowMO(500, 2.0f);  
			}
