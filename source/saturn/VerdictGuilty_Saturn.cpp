...
{
	vg_saturn_debug_stage(1, "main_enter");
	...
	*/
	...
	glKosInit();
	vg_saturn_debug_stage(2, "after_glKosInit");

	set_system_ram();
	vg_saturn_debug_stage(3, "after_set_system_ram");
...
//	MAX_vertical   = GetSystemMetrics(SM_CYSCREEN);
    ...
    TimerInit();
	vg_saturn_debug_stage(6, "after_timer_init");
 ...
 //SPLASH SCREEN PIXEL
	...
	vg_saturn_debug_stage(7, "after_initial_scene");



	//Load_KMG_inde("VMUALERT.png.tex", &VMU_ALERT);

	// Saturn: Dreamcast VMU save checks and splash screens are intentionally removed.

	printf("PASS CREATE WINDOWS !\n");
	vg_saturn_debug_stage(8, "after_boot_splash");
    ...
    LoadCFG();         
	vg_saturn_debug_stage(9, "after_second_loadcfg");
